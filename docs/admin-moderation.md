...
なりすましの本人確認では身分証明書を収集しません。利用者は編集画面から登録済みSNSと投稿予定内容を事前に申請し、申請から10分以内に一致する任意の文章または写真を投稿します。申請時のSNS URL、投稿予定内容、投稿期限は履歴として保存されます。管理者による照合が完了するまではプロフィールの非公開を維持します。
